	...
	Private Function ICustomFunctionOperator_Evaluate(ParamArray ByVal operands() As Object) As Object Implements ICustomFunctionOperator.Evaluate
		If operands.Length = 3 Then
			...
			If Not String.IsNullOrEmpty(state) Then
				Dim shippedDate = If(Not ReferenceEquals(operands(1), Nothing), Convert.ToDateTime(operands(1)), DateTime.MaxValue)
				Dim requiredDate = If(Not ReferenceEquals(operands(2), Nothing), Convert.ToDateTime(operands(2)), DateTime.MaxValue)
				Select Case state
					Case "OK"
